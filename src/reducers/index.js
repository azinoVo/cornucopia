...
const initialState = {
    ...
    game: {
        ...
        date: 0,
        calendar: [
            {id: 1, date: "Spring Cycle: Day I", benefit: "Spring plants are flourishing."},
            {id: 2, date: "Spring Cycle: Day II", benefit: "Spring plants are flourishing."},
            {id: 3, date: "Spring Cycle: Day III", benefit: "Spring plants are flourishing."},
            {id: 4, date: "Spring Cycle: Day IV", benefit: "Spring plants are flourishing."},
            {id: 5, date: "Spring Cycle: Day V", benefit: "Spring plants look stunning today."},
            {id: 6, date: "Summer Cycle: Day I", benefit: "Summer plants are flourishing."},
            {id: 7, date: "Summer Cycle: Day II", benefit: "Summer plants are flourishing."},
            {id: 8, date: "Summer Cycle: Day III", benefit: "Summer plants are flourishing."},
            {id: 9, date: "Summer Cycle: Day IV", benefit: "Summer plants are flourishing."},
            {id: 10, date: "Summer Cycle: Day V", benefit: "Summer plants look stunning today."},
            {id: 11, date: "Autumn Cycle: Day I", benefit: "Autumn plants are flourishing."},
            {id: 12, date: "Autumn Cycle: Day II", benefit: "Autumn plants are flourishing."},
            {id: 13, date: "Autumn Cycle: Day III", benefit: "Autumn plants are flourishing."},
            {id: 14, date: "Autumn Cycle: Day IV", benefit: "Autumn plants are flourishing."},
            {id: 15, date: "Autumn Cycle: Day V", benefit: "Autumn plants look stunning today."},
            {id: 16, date: "Winter Cycle: Day I", benefit: "Winter plants are flourishing."},
            {id: 17, date: "Winter Cycle: Day II", benefit: "Winter plants are flourishing."},
            {id: 18, date: "Winter Cycle: Day III", benefit: "Winter plants are flourishing."},
            {id: 19, date: "Winter Cycle: Day IV", benefit: "Winter plants are flourishing."},
            {id: 20, date: "Winter Cycle: Day V", benefit: "Winter plants look stunning today."},
        ],
        interact_list: [
            // {value: "", label: ""},
        ],
